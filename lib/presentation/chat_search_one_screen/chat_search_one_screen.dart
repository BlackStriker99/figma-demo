...
class ChatSearchOneScreen extends GetWidget<ChatSearchOneController> {
  @override
                                                                    ...
                                                                    child: Row(
                                                                        ...
                                                                        children: [
                                                                          Padding(
                                                                              ...
                                                                              child: ClipRRect(borderRadius: BorderRadius.circular(getHorizontalSize(9.44)), child: CommonImageView(imagePath: ImageConstant.imgEllipse24x24, height: getSize(18.00), width: getSize(18.00), fit: BoxFit.cover))),
                                                                          Container(
                                                                              height: getVerticalSize(26.00),
                                                                              width: getHorizontalSize(108.00),
                                                                              margin: getMargin(left: 3),
                                                                              child: Stack(alignment: Alignment.centerLeft, children: [
                                                                                Align(alignment: Alignment.topLeft, child: Padding(padding: getPadding(top: 3, bottom: 10), child: Text("msg_ahmed_yusuf".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtOpenSansRomanSemiBold944.copyWith(height: 1.00)))),
                                                                                Align(
                                                                                    alignment: Alignment.centerLeft,
                                                                                    child: Padding(
                                                                                        padding: getPadding(left: 1, right: 10),
                                                                                        child: Row(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.max, children: [
                                                                                          Padding(padding: getPadding(top: 16), child: Text("lbl_ahmed_yusuf".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtOpenSansRomanRegular786.copyWith(height: 1.00))),
                                                                                          Padding(padding: getPadding(left: 3, bottom: 7), child: CommonImageView(svgPath: ImageConstant.imgSettings, height: getSize(18.00), width: getSize(18.00)))
                                                                                        ])))
                                                                              ]))
                                                                        ])),
                                                                Align(
                                                                    ...
                                                                    child: Container(
                                                                        ...
                                                                        child: Text(
                                                                            ...
                                                                            textAlign:
                                                                                TextAlign.left,
                                                                            style: AppStyle.txtOpenSansRomanRegular944.copyWith(height: 1.33))))
                                                              ]))
                                                    ]))),
                                        Align(
                                            alignment: Alignment.centerLeft,
