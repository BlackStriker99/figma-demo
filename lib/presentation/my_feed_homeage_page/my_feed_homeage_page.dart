import '../my_feed_homeage_page/widgets/listellipse_twelve_item_widget.dart';
import 'controller/my_feed_homeage_controller.dart';
import 'models/listellipse_twelve_item_model.dart';
import 'models/my_feed_homeage_model.dart';
import 'package:brijesh_s_application1/core/app_export.dart';
import 'package:flutter/material.dart';

// ignore_for_file: must_be_immutable
class MyFeedHomeagePage extends StatelessWidget {
  MyFeedHomeageController controller =
      Get.put(MyFeedHomeageController(MyFeedHomeageModel().obs));
                ...
                child: Column(
                                                              ...
                                                              children: [
                                                                Align(
                                                                    ...
                                                                    child: Container(
                                                                        ...
                                                                        margin: getMargin(right: 8, bottom: 10),
                                                                        child: RichText(
                                                                ...
                                                                Align(
                                                                    ...
                                                                    child: Container(
                                                                        ...
                                                                        child: Stack(alignment: Alignment.topRight, children: [
                                                                          Align(
                                                                              alignment: Alignment.topLeft,
                                                                              child: Padding(padding: getPadding(top: 4, right: 10, bottom: 10), child: ClipRRect(borderRadius: BorderRadius.circular(getHorizontalSize(11.48)), child: CommonImageView(imagePath: ImageConstant.imgEllipse, height: getVerticalSize(20.00), width: getHorizontalSize(22.00), fit: BoxFit.cover)))),
                                                                          Align(
                                                                              alignment: Alignment.topRight,
                                                                              child: Padding(padding: getPadding(left: 10, right: 9, bottom: 10), child: ClipRRect(borderRadius: BorderRadius.circular(getHorizontalSize(11.48)), child: CommonImageView(imagePath: ImageConstant.imgEllipse20x22, height: getVerticalSize(20.00), width: getHorizontalSize(22.00), fit: BoxFit.cover)))),
                                                                          Align(
                                                                              alignment: Alignment.topLeft,
                                                                              child: Padding(padding: getPadding(left: 18, right: 18, bottom: 10), child: ClipRRect(borderRadius: BorderRadius.circular(getHorizontalSize(11.48)), child: CommonImageView(imagePath: ImageConstant.imgEllipse1, height: getVerticalSize(20.00), width: getHorizontalSize(22.00), fit: BoxFit.cover)))),
                                                                          Align(
                                                                              alignment: Alignment.bottomRight,
                                                                              child: Padding(padding: getPadding(left: 18, top: 10, right: 18), child: ClipRRect(borderRadius: BorderRadius.circular(getHorizontalSize(11.48)), child: CommonImageView(imagePath: ImageConstant.imgEllipse2, height: getVerticalSize(20.00), width: getHorizontalSize(22.00), fit: BoxFit.cover)))),
                                                                          Align(
                                                                              alignment: Alignment.bottomLeft,
                                                                              child: Padding(padding: getPadding(left: 11, top: 10, right: 11, bottom: 1), child: ClipRRect(borderRadius: BorderRadius.circular(getHorizontalSize(11.48)), child: CommonImageView(imagePath: ImageConstant.imgEllipse3, height: getVerticalSize(20.00), width: getHorizontalSize(22.00), fit: BoxFit.cover)))),
                                                                          Align(
                                                                              alignment: Alignment.bottomRight,
                                                                              child: Container(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Padding(
                                                                          ...
                                                                          child: Text(
                                                                              ...
                                                                              textAlign: TextAlign.left,
                                                                              style: AppStyle.txtOpenSansRomanRegular8.copyWith(height: 1.00))),
                                                                      Padding(
                                                                          padding: getPadding(
                                                                              left:
                                                                                  51,
                  ...
                  Align(
                      ...
                      child: Container(
                          ...
                          margin: getMargin(left: 1, top: 15, right: 1),
                          decoration: AppDecoration.fillGray50.copyWith(
                              borderRadius: BorderRadiusStyle.roundedBorder10),
                          child: Column(
                              mainAxisSize: MainAxisSize.min,
                          ...
                          children: [
                            Align(
                                ...
                                child: Obx(() => ListView.builder(
                                    ...
                                    shrinkWrap: true,
                                    itemCount: controller.myFeedHomeageModelObj
                                        .value.listellipseTwelveItemList.length,
                                    itemBuilder: (context, index) {
                                      ListellipseTwelveItemModel model =
                                          controller.myFeedHomeageModelObj.value
                                              .listellipseTwelveItemList[index];
                                      return ListellipseTwelveItemWidget(model,
                                          onTapImgGroup13850:
                                              onTapImgGroup13850,
                                          onTapImgShareTwo: onTapImgShareTwo);
                                    })))
                          ]))
                ]))));
  }
  ...
  onTapImgGroup13850() {
    Get.toNamed(AppRoutes.optionsForOwnerOnYarnsScreen);
  }
